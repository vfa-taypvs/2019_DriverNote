 ...
 */
public class ListSubTopicGridAdapter extends BaseAdapter {

    public List<String> subTopics;
    private LayoutInflater mInflater;
    private Context context;

    public ListSubTopicGridAdapter(Context context, List<String> subTopics){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = mInflater.inflate(R.layout.adapter_list_sub_topic_grid, null);
        ...
        holder.name.setText(subTopics.get(i));
        return view;
    }
